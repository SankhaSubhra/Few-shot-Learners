...
from reptile_src.models_reptile import MiniImageNetModel
...
def main():
    ...
    fileStart = 'miniimagenet_reptile_checkpoint_seed_' + str(args.seed)
    ...
    val_accuracies, val_accuracy, val_variation = evaluate(reptile_model, val_set, **eval_kwargs)
