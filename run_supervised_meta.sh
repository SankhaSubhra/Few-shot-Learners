...
python -u run_miniimagenet_reptile.py --seed 0 --shots 1 --inner-batch 10 --inner-iters 8 --meta-step 1 --meta-batch 5 --meta-iters 100000 --eval-batch 5 --eval-iters 50 --eval-samples 1000 --learning-rate 0.001 --train-shots 15 | tee reptile_miniimagenet_seed0.txt
